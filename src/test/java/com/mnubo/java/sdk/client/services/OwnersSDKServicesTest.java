...
public class OwnersSDKServicesTest extends AbstractServiceTest {
    ...
    public void ownerSetup() {
        ...
        resultsMockSetup.add(new Result("idOwnerTest1", "sucess", ""));
        resultsMockSetup.add(new Result("idOwnerTest2", "error", "Invalid attribute X for the Owner"));
        resultsMockSetup.add(new Result("idOwnerTest3", "error", "Error Z"));
        resultsMockSetup.add(new Result("idOwnerResult4", "sucess", ""));
    ...
    @Test
    public void createOrUpdateOwnersThenOk() {
        ...
        List<Result> results = ownerClient.createOrUpdateOwners(owners);

        validateResult(results);
    }

    @Test
    public void createOrUpdateOwnersNullThenFail() {

        expectedException.expect(IllegalStateException.class);
        expectedException.expectMessage("List of owners body cannot be null.");
        ownerClient.createOrUpdateOwners(null);
    }
